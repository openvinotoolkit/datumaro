...
``` bash
datum convert -if mot -i <path/to/dataset> -o <output/dir>
```
...
You can convert the MOT dataset to other dataset formats using CLI:
...
You can convert a dataset to the MOT format using CLI:
