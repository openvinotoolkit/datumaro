...
## Convert Supervisely Point Cloud dataset
...
Use the command below to convert a Supervisely Point Cloud dataset:
...
### Example 1. Convert dataset, compute statistics

```bash
datum convert -if sly_pointcloud -i ../sly_dataset/ -f datumaro -o ./output_project
datum stats -i ./output_project
```
