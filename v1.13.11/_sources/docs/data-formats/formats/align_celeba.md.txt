...
## Convert align CelebA dataset

A Datumaro dataset can be converted in the following way:

```bash
datum convert -if align_celeba -i <path/to/dataset> -o <output/dir>
```
...
You can convert an align CelebA dataset to other dataset formats using CLI:
