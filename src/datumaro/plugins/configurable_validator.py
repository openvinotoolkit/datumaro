...
class StatsData:
    ...
    multiple_label: Optional[Set[Tuple[str, str]]] = field(default=None)  # item_id, item_subset
    invalid_value: Optional[Set[Tuple[str, str]]] = field(
        default=None
    )  # item_id, item_subset, annotation_id
    negative_length: Optional[Set[Tuple[str, str]]] = field(
        default=None
    )  # item_id, item_subset, annotation_id
...
class DetStats(_BaseAnnStats):
    ...
    def __init__(self, label_categories: LabelCategories, warnings: set):
        ...
        for label_cat in self.label_categories.items:
            label_name = label_cat.name
            self.stats.categories[label_name]["pts"] = []  # (id, subset, ann_id, w, h)
...
class SegStats(_BaseAnnStats):
    ...
    def __init__(self, label_categories: LabelCategories, warnings: set):
        ...
        for label_cat in self.label_categories.items:
            label_name = label_cat.name
            self.stats.categories[label_name]["pts"] = []
...
class ConfigurableValidator(Validator, CliPlugin):
    ...
    def _check_multiple_label(self, stats: StatsData):
        validation_reports = []
    ...
    def _check_negative_length(self, stats: StatsData):
        validation_reports = []
    ...
    def _check_invalid_value(self, stats: StatsData):
        validation_reports = []
