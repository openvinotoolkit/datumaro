...
def print_statistics(processing_times, batch_size):
    ...
    print(
        "average time: {:.2f} ms; average speed: {:.2f} fps".format(
    ...
    print(
        "median time: {:.2f} ms; median speed: {:.2f} fps".format(
    ...
    print(
        "max time: {:.2f} ms; min speed: {:.2f} fps".format(
    ...
    print(
        "min time: {:.2f} ms; max speed: {:.2f} fps".format(
    ...
    print(
        "time percentile 90: {:.2f} ms; speed percentile 90: {:.2f} fps".format(
            round(np.percentile(processing_times, 90), 2),
            round(1000 * batch_size / np.percentile(processing_times, 90), 2),
        )
    )
    print(
        "time percentile 50: {:.2f} ms; speed percentile 50: {:.2f} fps".format(
