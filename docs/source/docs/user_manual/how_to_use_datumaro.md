...
- Other:
  - Transform - A transformation operation over dataset elements. Examples
    ...
    label remapping etc. Corresponds to the [`transform` command](/docs/user_manual/command_reference/transform).
...
- Use the [`convert`](/docs/user_manual/command_reference/convert)
, [`diff`](/docs/user_manual/command_reference/diff)
, [`merge`](/docs/user_manual/command_reference/merge)
 commands directly on existing datasets

- Create a Datumaro project and operate on it:
  - Create an empty project with [`create`](/docs/user_manual/command_reference/create)
  - Import existing datasets with [`import`](/docs/user_manual/command_reference/sources#source-import)
  - Modify the project with [`transform`](/docs/user_manual/command_reference/transform) and [`filter`](/docs/user_manual/command_reference/filter)
  - Create new revisions of the project with
    [`commit`](/docs/user_manual/command_reference/commit), navigate over
    them using [`checkout`](/docs/user_manual/command_reference/checkout),
    compare with [`diff`](/docs/user_manual/command_reference/diff), compute
    statistics with [`stats`](/docs/user_manual/command_reference/stats)
  - Export the resulting dataset with [`export`](/docs/user_manual/command_reference/export)
  - Check project config with [`project info`](/docs/user_manual/command_reference/projects/#print-project-info)
...
datasets in a project by commands in the [`datum source`](/docs/user_manual/command_reference/sources)
...
first using the [`model add`](/docs/user_manual/command_reference/models/#register-model) command.
...
![project model](../../_static/images/project_model.svg)
...
![build tree](../../_static/images/build_tree.svg)
...
the [`datum source`](/docs/user_manual/command_reference/sources) command
line context.
...
![cache interaction diagram 1](../../_static/images/behavior_diag1.svg)
...
![cache interaction diagram 2](../../_static/images/behavior_diag2.svg)
...
![cache interaction diagram 3](../../_static/images/behavior_diag3.svg)
