...
- Rename images in a project data source by a regex from `frame_XXX` to `XXX`:
  ...
  **__note:__** Please use double quotes (`"`) for regex representation. (Reason to use doulbe quotes)[https://stackoverflow.com/questions/51080215/differences-between-single-and-double-quotes-in-cmd]
