...
.. toctree::
   ...
   datumaro.plugins.datumaro_format
   datumaro.plugins.icdar_format
   datumaro.plugins.kitti_format
   datumaro.plugins.kitti_raw_format
   datumaro.plugins.openvino_plugin
   datumaro.plugins.sampler
   datumaro.plugins.sly_pointcloud_format
   datumaro.plugins.tf_detection_api_format
