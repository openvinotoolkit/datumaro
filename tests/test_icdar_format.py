            ...
            DatasetItem(id=1, subset='train',
                annotations=[
                    Mask(id=1, image=np.array([[0, 0, 0, 1, 1]]), label=2,
                        group=1, attributes = { 'color': (82, 174, 214), 'text': 'j',
                        'center': [0, 3] }),
                    Mask(id=0, image=np.array([[0, 1, 1, 0, 0]]), label=1,
                        group=1, attributes = { 'color': (108, 225, 132), 'text': 'F',
                        'center': [0, 1] }),
                ]),
            DatasetItem(id=2, subset='train',
                annotations=[
                    Mask(id=0, image=np.array([[0, 0, 0, 0, 0, 1]]), label=4,
                        group=0, attributes = { 'color': (183, 6, 28), 'text': ' ',
                        'center': [0, 5] }),
                    Mask(id=0, image=np.array([[1, 0, 0, 0, 0, 0]]), label=1,
                        group=1, attributes = { 'color': (108, 225, 132), 'text': 'L',
                        'center': [0, 0] }),
                    Mask(id=1, image=np.array([[0, 0, 0, 1, 1, 0]]), label=2,
                        group=1, attributes = { 'color': (82, 174, 214), 'text': 'o',
                        'center': [0, 3] }),
                    Mask(id=0, image=np.array([[0, 1, 1, 0, 0, 0]]), label=3,
                        group=0, attributes = { 'color': (241, 73, 144), 'text': 'P',
                        'center': [0, 1] }),
                ]),
        ])
