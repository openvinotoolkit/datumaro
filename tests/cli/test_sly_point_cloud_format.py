...
class SlyPointCloudIntegrationScenarios(TestCase):
    ...
    def test_can_convert_to_kitti_raw(self):
        with TestDir() as test_dir:
            ...
            expected_label_cat.add('bus', attributes={'tag1', 'tag3', 'object'})
            expected_label_cat.add('car', attributes={'tag1', 'tag3', 'object'})
                ...
                DatasetItem(id='frame1',
                    annotations=[
                        Cuboid3d(label=1,
                            ...
                            attributes={'track_id': 3, 'object': 231825,
                                'tag1': 'fd', 'tag3': '4s', 'occluded': False}),

                        Cuboid3d(label=1,
                            position=[0.36, 0.64, 0.93],
                            scale=[0.01, 0.01, 0.01],
                            attributes={'track_id': 2, 'object': 231831,
                ...
                DatasetItem(id='frame2',
                    annotations=[
                        Cuboid3d(label=0,
                            ...
                            attributes={'track_id': 1, 'object': 36,
            ...
            run(self, 'export', '-p', test_dir,
                ...
                '--', '--save-images', '--reindex', '--allow-attrs')
