...
class ImageZipExporterTest(TestCase):
    ...
    def test_can_save_and_load(self):
        source_dataset = Dataset.from_iterable(
            [
                DatasetItem(id="1", media=Image.from_data(data=np.ones((10, 6, 3)))),
                DatasetItem(id="2", media=Image.from_data(data=np.ones((5, 4, 3)))),
            ]
        )
    ...
    def test_can_save_and_load_with_custom_archive_name(self):
        source_dataset = Dataset.from_iterable(
            [
                DatasetItem(id="img_1", media=Image.from_data(data=np.ones((10, 10, 3)))),
            ]
        )
    ...
    def test_relative_paths(self):
        source_dataset = Dataset.from_iterable(
            [
                DatasetItem(id="1", media=Image.from_data(data=np.ones((10, 10, 3)))),
                DatasetItem(id="a/2", media=Image.from_data(data=np.ones((4, 5, 3)))),
                DatasetItem(id="a/b/3", media=Image.from_data(data=np.ones((20, 10, 3)))),
            ]
        )
    ...
    def test_can_save_and_load_custom_compresion_method(self):
        source_dataset = Dataset.from_iterable(
            [
                DatasetItem(id="1", media=Image.from_data(data=np.ones((5, 5, 3)))),
                DatasetItem(id="2", media=Image.from_data(data=np.ones((4, 3, 3)))),
            ]
        )
    ...
    def test_can_save_and_load_with_arbitrary_extensions(self):
        source_dataset = Dataset.from_iterable(
            [
                DatasetItem(id="subset/1", media=Image.from_data(data=np.ones((10, 10, 3)))),
                DatasetItem(id="2", media=Image.from_data(data=np.ones((4, 5, 3)))),
            ]
        )
...
class ImageZipImporterTest(TestCase):
    ...
    def test_can_import_from_directory(self):
        source_dataset = Dataset.from_iterable(
            [
                DatasetItem(id="1", media=Image.from_data(data=np.ones((10, 10, 3)))),
                DatasetItem(id="2", media=Image.from_data(data=np.ones((5, 10, 3)))),
            ]
        )
