...
@pytest.fixture
def fxt_refined_missing_cat_dataset():
    return Dataset.from_iterable(
        [
            DatasetItem(
                id="normal_train_0",
...
@pytest.fixture
def fxt_refined_missing_label_dataset():
    return Dataset.from_iterable(
        [
            DatasetItem(
                id="normal_train_0",
...
@pytest.fixture
def fxt_refined_missing_attr_dataset():
    return Dataset.from_iterable(
        [
            DatasetItem(
                id="normal_train_0",
...
@pytest.fixture
def fxt_refined_multi_label_dataset():
    return Dataset.from_iterable(
        [
            DatasetItem(
                id="normal_train_0",
...
@pytest.fixture
def fxt_refined_undefined_label_dataset():
    return Dataset.from_iterable(
        [
            DatasetItem(
                id="normal_train_0",
...
@pytest.fixture
def fxt_refined_undefined_attr_dataset():
    return Dataset.from_iterable(
        [
            DatasetItem(
                id="normal_train_0",
...
@pytest.fixture
def fxt_refined_neg_len_dataset():
    return Dataset.from_iterable(
        [
            DatasetItem(
                id="normal_train_0",
...
@pytest.fixture
def fxt_refined_invalid_val_dataset():
    return Dataset.from_iterable(
        [
            DatasetItem(
                id="normal_train_0",
...
@pytest.fixture
def fxt_refined_far_from_mean_dataset():
    return Dataset.from_iterable(
        [
            DatasetItem(
                id="normal_train_0",
...
@pytest.fixture
def fxt_refined_far_from_mean_attr_dataset():
    return Dataset.from_iterable(
        [
            DatasetItem(
                id="normal_train_0",
