            ...
            [
                ...
                DatasetItem(id='b', subset='train', image=np.zeros((8, 8, 3)),
                    annotations=[
                        ...
                        Mask(label=1, image=np.ones((8, 8)), attributes={
                            'box_id': '00000000',
                            'box': {'x': 2, 'y': 3, 'w': 6, 'h': 1},
                            'predicted_iou': 0.75,
                        }),
                ...
                DatasetItem(id='b', subset='train', image=np.zeros((2, 8, 3)),
                    annotations=[
                        ...
                        Mask(label=0, image=np.hstack((np.ones((2, 2)), np.zeros((2, 6)))),
                            attributes={
                                'box_id': '01234567',
                                # for simplicity, we don't bother ensuring that the test
                                # mask actually lies within the corresponding box
                                'box': {'x': 1.6, 'y': 0.6, 'w': 6.4, 'h': 0.4},
                                'predicted_iou': 0.5,
                            }
                        ),
                    ]),
