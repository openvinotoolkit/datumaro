...
class Market1501FormatTest(TestCase):
    ...
    def test_can_save_and_load_image_with_arbitrary_extension(self):
        expected = Dataset.from_iterable([
            DatasetItem(id='c/0001_c1s1_000000_00', media=Image(
                    path='c/0001_c1s1_0000_00.JPEG', data=np.zeros((4, 3, 3))),
                attributes={'camera_id': 0, 'person_id': '0001', 'track_id': 1,
                    'frame_id': 0, 'bbox_id': 0, 'query': False}
            ),
            DatasetItem(id='a/b/0002_c2s2_000001_00', media=Image(
    ...
    def test_can_import(self):
        expected_dataset = Dataset.from_iterable([
            ...
            DatasetItem(id='0002_c1s3_000151_00',
                subset='train', media=Image(data=np.ones((2, 5, 3))),
